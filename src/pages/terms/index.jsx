        ...
        <div className="policy__wrapper stack column">
          <div className="policy__top stack column">
            ...
            <Typography tag="p" variant="p" center>
              Your Terms & Conditions is important to us at GhostReach. We
              respect your Terms & Conditions regarding any information we may
          ...
          <div className="policy__body stack column">
            <div className="policy__text stack column">
              <Typography tag="p" variant="p">
                Terms & Conditions Your Terms & Conditions is important to us at
                GhostReach. We are committed to protecting your personal
                information and your right to Terms & Conditions. This Terms &
                Conditions Policy explains what information we collect, how we
                use it, and what rights you have concerning your data.
              </Typography>
            </div>
            ...
            <div className="policy__text stack column">
              ...
              <Typography tag="p" variant="p">
                ...
                fulfill the purposes outlined in this Terms & Conditions Policy
                unless a longer retention period is required by law. Once the
            ...
            <div className="policy__text stack column">
              <Typography tag="h2" variant="h2" color="dark" weight="600">
                What are your Terms & Conditions rights?
              </Typography>
              <Typography tag="p" variant="p">
            ...
            <div className="policy__text stack column">
              ...
              <Typography tag="p" variant="p">
                If you have any questions or concerns regarding this Terms &
                Conditions Policy, you can reach out to us at:
              </Typography>
              <Typography tag="p" variant="p">
                We reserve the right to update this Terms & Conditions Policy as
                necessary to reflect changes in our practices. Any modifications
